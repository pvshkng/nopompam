...
export function CandlestickChart(props: any) {
  ...
  return (
    <div
      className="relative w-full h-96 rounded-sm bg-white border border-blue-200 !p-5"
      /* style={
        {
          "--marginTop": "20px",
          "--marginRight": "60px",
    ...
    >
      ...
      <div
        className="absolute right-0 bg-blue-500 text-white px-2 py-1 text-xs font-medium"
        style={{
          top: `calc(${yScale(
