    ...
    <Dialog>
      ...
      >
        <DialogHeader>
          ...
          <Button
            className="rounded-none bg-stone-700 hover:bg-stone-800"
            onClick={handleConfirm}
          >
            {loading ? (
              <div className="w-[30px] h-[30px] border-4 border-stone-300 border-t-stone-800 rounded-full animate-spin" />
            ) : (
              "Delete"
            )}
          </Button>
